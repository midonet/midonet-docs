...
set       toc,title
  ...
  <xsl:param name="use.version.for.disqus">0</xsl:param>
	...
	<div class="logabug" style="text-align: center">
	  <a id="AskOOLink2" href="https://wiki.midonet.org/Mailing%20lists%20and%20IRC" target="_blank"><i class="icon-question"><xsl:comment/></i>Questions? Discuss on Mailing Lists or Chat.</a>
          <br/>
...
ERROR: Feedback email not set but internal comments are enabled.
    ...
    <xsl:if test="$branding = 'midonet' and $social.icons = '0'">
      <div id="gplusone">
        <a id="AskOOLink1" href="https://wiki.midonet.org/Mailing%20lists%20and%20IRC" target="_blank" title="Questions? Discuss on Mailing Lists or Chat."><i class="icon-question"><xsl:comment/></i></a>&#160;&#160;
