...
set       toc,title
  ...
  <xsl:param name="main.docs.url">
    <xsl:choose>
      ...
      <xsl:when test="$branding = 'midonet'">https://docs.midonet.org/</xsl:when>
  ...
  <xsl:param name="use.version.for.disqus">0</xsl:param>
	...
	<div class="logabug" style="text-align: center">
	  <a id="AskOOLink2" href="https://github.com/midonet/midonet/wiki/Communication" target="_blank"><i class="icon-question"><xsl:comment/></i>Questions? Discuss on Mailing Lists or Chat.</a>
          <br/>
	...
	<div class="logabug" style="text-align: center">
	  <a id="AskOOLink2" href="https://ask.openstack.org" target="_blank"><i class="icon-question"><xsl:comment/></i>Questions? Discuss on ask.openstack.org</a>
          <br/>
...
ERROR: Feedback email not set but internal comments are enabled.
    ...
    <xsl:if test="$branding = 'midonet' and $social.icons = '0'">
      <div id="gplusone">
        <a id="AskOOLink1" href="https://github.com/midonet/midonet/wiki/Communication" target="_blank" title="Questions? Discuss on Mailing Lists or Chat."><i class="icon-question"><xsl:comment/></i></a>&#160;&#160;
    ...
    <xsl:if test="$branding = 'openstack' and $social.icons = '0'">
      <div id="gplusone">
        <a id="AskOOLink1" href="https://ask.openstack.org" target="_blank" title="Questions? Discuss on ask.openstack.org"><i class="icon-question"><xsl:comment/></i></a>&#160;&#160;
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>      
	  ...
	  <a onclick="_gaq.push(['_trackEvent', 'Header', 'logo', 'click', 1]);" target="_blank">
		...
		<xsl:when test="$branding = 'midonet'">https://www.midonet.org</xsl:when>
