...
[code]
----
<xi:include href="docinfo_productname_{lang}.xml" [...]>
[...]
<xi:include href="docinfo_abstract_{lang}.xml" [...]>
----

== Main Contents

The document's main contents, i.e. chapters and sections, are being include from
the base book file and thus have separate versions for each language:
