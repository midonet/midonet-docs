...
include::{sourcedir}/uplinks/section_static_chapter_setup_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/uplinks/section_static_setup_{lang}.adoc[leveloffset=+3]
include::{sourcedir}/uplinks/section_fakeuplink_setup_{lang}.adoc[leveloffset=+3]
...
include::{sourcedir}/routing/section_ecmp_limitations_{lang}.adoc[leveloffset=+2]
...
include::{sourcedir}/nat/section_dnat_example_{lang}.adoc[leveloffset=+2]
...
// Chapter: Layer 4 Load Balancing
include::{sourcedir}/neutron_lbaas/chapter_neutron_lbaas_{lang}.adoc[leveloffset=+1]
...
include::{sourcedir}/monitoring/section_port_mirroring_{lang}.adoc[leveloffset=+2]
...
include::{sourcedir}/vxlan/section_vtep_ha_{lang}.adoc[leveloffset=+2]
...
include::{sourcedir}/service_containers/chapter_service_containers_{lang}.adoc[leveloffset=+1]
include::{sourcedir}/service_containers/section_container_configuration_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/service_containers/section_container_management_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/service_containers/section_container_scheduling_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/service_containers/section_container_troubleshooting_{lang}.adoc[leveloffset=+2]

// Chapter: Service Function Chaining
include::{sourcedir}/service_insertion_chaining/chapter_service_insertion_chaining_{lang}.adoc[leveloffset=+1]
include::{sourcedir}/service_insertion_chaining/section_service_function_model_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/service_insertion_chaining/section_l2insertion_object_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/service_insertion_chaining/section_l2insertion_cli_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/service_insertion_chaining/section_alternatives_{lang}.adoc[leveloffset=+2]

// Chapter: Router Peering
include::{sourcedir}/router_peering/chapter_router_peering_{lang}.adoc[leveloffset=+1]
include::{sourcedir}/router_peering/section_diagrams_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_create_tenant_routers_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_create_gateway_device_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_create_multiside_network_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_peer_tenant_router_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_add_remote_mac_entry_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_configure_edge_bindings_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_delete_remote_mac_entry_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_delete_l2_gateway_connection_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_delete_l2_gateway_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_delete_gateway_device_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/router_peering/section_neutron_cli_{lang}.adoc[leveloffset=+2]

// Chapter: FWaaS Logging
include::{sourcedir}/fwaas/chapter_fwaas_logging_{lang}.adoc[leveloffset=+1]

// Chapter: Neutron BGP (Dynamic Routing)
include::{sourcedir}/neutron_bgp/chapter_neutron_bgp_{lang}.adoc[leveloffset=+1]

// Chapter: VPNaaS
include::{sourcedir}/vpnaas/chapter_vpnaas_{lang}.adoc[leveloffset=+1]

// Chapter: QoS
include::{sourcedir}/qos/chapter_qos_{lang}.adoc[leveloffset=+1]

// Chapter: FIP64
include::{sourcedir}/fip64/chapter_fip64_{lang}.adoc[leveloffset=+1]

// Chapter: Neutron QoS
include::{sourcedir}/neutron_qos/chapter_neutron_qos_{lang}.adoc[leveloffset=+1]

// Chapter: State Proxy
include::{sourcedir}/state_proxy/chapter_state_proxy_{lang}.adoc[leveloffset=+1]

// Chapter: Flow state storage
include::{sourcedir}/flowstate_storage/chapter_flowstate_storage_{lang}.adoc[leveloffset=+1]
...
include::{sourcedir}/backup/chapter_backup_restore_{lang}.adoc[leveloffset=+1]
include::{sourcedir}/backup/section_zookeeper_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/backup/section_cassandra_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/backup/section_midolman_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/backup/section_cluster_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/backup/section_mysql_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/backup/section_neutron_{lang}.adoc[leveloffset=+2]
include::{sourcedir}/backup/section_libvirt_{lang}.adoc[leveloffset=+2]
