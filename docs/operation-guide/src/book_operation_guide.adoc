...
include::uplinks/section_static_setup.adoc[leveloffset=+2]
...
include::monitoring/section_metering.adoc[leveloffset=+2]
...
include::monitoring/section_packet_tracing.adoc[leveloffset=+2]
...
include::vxlan/section_cli_delete_vtep.adoc[leveloffset=+3]
