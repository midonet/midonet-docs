...
include::{sourcedir}/{operating_system}/{openstack_version}/architecture/content_architecture_example_reference_{lang}.adoc[]
...
include::{sourcedir}/common/openstack/listitem_keystone_midonet_service_configuration_{lang}.adoc[]
...
include::{sourcedir}/{operating_system}/{openstack_version}/openstack/section_neutron_network_node_installation_{lang}.adoc[leveloffset=+3]
