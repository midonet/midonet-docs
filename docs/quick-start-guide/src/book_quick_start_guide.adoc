...
include::{sourcedir}/{operating_system}/basic_environment/listitem_repo_config_java8_{lang}.adoc[]
...
include::{sourcedir}/{operating_system}/{openstack_version}/openstack/section_neutron_lbaas_installation_{lang}.adoc[leveloffset=+4]
include::{sourcedir}/{operating_system}/{openstack_version}/openstack/section_neutron_fwaas_installation_{lang}.adoc[leveloffset=+4]
include::{sourcedir}/{operating_system}/{openstack_version}/openstack/section_neutron_qos_installation_{lang}.adoc[leveloffset=+4]
...
// Chapter: Initial Network Configuration
include::{sourcedir}/{operating_system}/{openstack_version}/openstack/chapter_initial_network_configuration_{lang}.adoc[leveloffset=+1]

// Chapter: BGP Uplink Configuration
include::{sourcedir}/common/uplinks/section_edge_router_setup_{lang}.adoc[leveloffset=+1]
